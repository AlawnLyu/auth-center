package com.lyu.auth.util.keygen;
...
public class KeyGeneric {
  ...
  private static final long MACHINE_BIT = 7; // 机器标识占用的位数
  private static final long DATA_CENTER_BIT = 3; // 数据中心占用的位数
   ...
   */
  public KeyGeneric(long dataCenterId, long machineId) {
